...
export function _ZN12wasm_bindgen7convert8closures11invoke1_mut17h02c542d29262b218E(a: number, b: number, c: number): void;
export function _ZN129__LT_dyn_u20_core__ops__function__Fn_LT__LP__RP__GT__u2b_Output_u20__u3d__u20_R_u20_as_u20_wasm_bindgen__closure__WasmClosure_GT_8describe6invoke17h9a5d8bea3a2de417E(a: number, b: number): number;
export function _ZN12wasm_bindgen7convert8closures7invoke117hc10e59280f4405e5E(a: number, b: number, c: number): number;
export function __wbindgen_exn_store(a: number): void;
export function _ZN12wasm_bindgen7convert8closures11invoke2_mut17h5d7e84ef34ead990E(a: number, b: number, c: number, d: number): void;
